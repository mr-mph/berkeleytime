...
seed_database() {
  ...
  # Preserve local auth identity. Public dumps include GradTrak/ratings/reviews
  # (migrate those); users/schedules are omitted from the public dump and must
  # not be clobbered if a dump ever includes them.
